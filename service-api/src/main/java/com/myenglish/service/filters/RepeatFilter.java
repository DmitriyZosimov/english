...
/**
 * Filter checks the word is included in a database of properly answered words and showed several times.
...
public interface RepeatFilter {
    ...
    /**
     * Check the word is included in database of properly answered words and showed several times.
     *
